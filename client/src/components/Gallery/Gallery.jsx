          ...
          <div className="colum">
            <div className={cn("gallery__inside-left", option)}>
              ...
              <BlockInfo
                ...
                nameBtn="Все фото"
                title="Мы знаем, как"
                titleRed="преодолеть Ваши трудности"
                subTitle="Наши команда профессионалов, современное безопасное оборудование и гарантия качества нефтепродуктов - Ваш повод сотрудничать с РегионСнаб"
              />
            </div>
          </div>
          <div className="colum">
