            ...
            aboutTitle={
              <div style={{ textIndent: "30px" }}>
                ...
                <div style={{ textIndent: "30px" }}>
                  ...
                  в компании отлично налажены от поступления заявки
          ...
          <DirectionCart
            ...
            aboutTitle={
              <div style={{ textIndent: "30px" }}>
                ...
                <div style={{ textIndent: "30px" }}>
                  Мы являемся партнером крупнейших производителей
                  нефтепродуктов, гарантирующих качество. Мы работаем только с
                  нефтепродуктами, соответствующими стандартам ГОСТ и ЕВРО-5.
                  Склад ГСМ оборудован лабораторией, ежедневно осуществляется
                  контроль качества на приеме и выдаче нефтепродуктов
                </div>
              </div>
            }
          />
